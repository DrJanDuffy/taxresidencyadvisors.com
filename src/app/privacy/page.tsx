...
export const metadata: Metadata = {
  title: "Privacy Policy | KLB Consultants",
  description: "Privacy policy for taxresidencyadvisors.com and KLB Consultants.",
};
